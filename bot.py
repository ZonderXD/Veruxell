...
async def botinfo(ctx):
    ...
    embed.set_footer(text=f"𝙳𝚎𝚅𝚒𝚒#0001 © | Все права защищены", icon_url='https://cdn.discordapp.com/avatars/719605055547768894/a_c2e9abd558cd2d4aee76473cb06f30d7.gif?size=1024') # создаение футера
    await ctx.send(embed=embed)
